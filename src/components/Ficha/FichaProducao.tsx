  ...
  return (
    <div style={{
      ...
      {([Y_ROD, Y_S2, Y_S3] as number[]).map((yy, i) => {
        ...
        return <div key={`s${i}`} style={box(127, yy, CX_W, ends[i] - yy, { border: B1 })} />
      })}
      ...
      {([Y_SEP, Y_A1, Y_A2] as number[]).map((yy, i) => {
        ...
        return <div key={`a${i}`} style={box(127, yy, CX_W, ends[i] - yy, { border: B1 })} />
      })}
      ...
      <div style={box(X_MID, Y_AMI, X_DIR - X_MID, Y_SN - Y_AMI, {
        borderLeft: B, borderBottom: B1, display: 'flex',
      })}>
        <div style={{
          flex: 1, display: 'flex', alignItems: 'center',
          justifyContent: 'center', gap: 8, borderRight: B1, height: '100%',
        }}>
      ...
      <div style={box(X_MID, Y_SN, X_DIR - X_MID, Y_BOT - Y_SN, {
        borderLeft: B, display: 'flex', alignItems: 'flex-end',
